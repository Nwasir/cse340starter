...
ALTER TYPE public.account_type OWNER TO cse340_ukoh;
...
--3 Tables structure for table `inventory`
...
SET inv_image = REPLACE(inv_image, '/images/', '/images/vehicles/'),
  inv_thumbnail = REPLACE(inv_thumbnail, '/images/', '/images/vehicles/') CREATE TYPE public.purchase_type AS ENUM ('Client', 'Employee', 'Admin');

CREATE TYPE public.purchase_type AS ENUM ('Client', 'Employee', 'Admin');

-- Table structure for table `Purchase`
-- CREATE TABLE IF NOT EXISTS public.purchase (
--   purchase_id integer NOT NULL GENERATED BY DEFAULT AS IDENTITY,
--   purchase_firstname character varying NOT NULL,
--   purchase_lastname character varying NOT NULL,
--   purchase_email character varying NOT NULL,
--   purchase_address character varying NOT NULL,
--   purchase_phone integer NOT NULL,
--   purchase_price numeric(9, 0) NOT NULL,
--   purchase_cardnumber integer NOT NULL,
--   purchase_expirydate integer NOT NULL,
--   purchase_securitycode integer NOT NULL,
--   purchase_type purchase_type NOT NULL DEFAULT 'Client'::purchase_type,
--   CONSTRAINT purchase_pkey PRIMARY KEY (purchase_id)
-- );

CREATE TABLE IF NOT EXISTS public.purchase (
  purchase_id SERIAL PRIMARY KEY,
  purchase_firstname VARCHAR(255) NOT NULL,
  purchase_lastname VARCHAR(255) NOT NULL,
  purchase_email VARCHAR(255) NOT NULL,
  purchase_address VARCHAR(255) NOT NULL,
  purchase_phone VARCHAR(20) NOT NULL,
  purchase_price NUMERIC(9, 2) NOT NULL,
  purchase_cardnumber VARCHAR(16) NOT NULL,
  purchase_expirydate DATE NOT NULL,
  purchase_securitycode VARCHAR(4) NOT NULL,
  purchase_type VARCHAR(20) NOT NULL DEFAULT 'Client'
);